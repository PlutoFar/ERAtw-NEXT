...
const DEMO_SATO_LOCATION_SPECS: DemoSatoLocationSpec[] = [
  [201, "school_gate", "人里的门", "門", "street", "sato-main"],
  ...
  [220, "legacy.sato.220", "瞭望楼", "瞭", "interior", "sato-main"],
  ...
  areas: [
    {
      ...
      rows: createDemoTextRows([
        ...
        "全  木森 森    木               木森                      木森                      木森                      木森         木    木    森  合",
        "合    森木    森     木森       森林                      森林                      森林                      木森    森    木    全",
        "全  木    森    木       木森                      木森                      木森                      森林                  木   森林    森 合",
